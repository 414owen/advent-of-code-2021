function runchart(reportDataParam) {
  'use strict';
  ...
  var colors = ["#ff5555", "#ff7777", "#ff0000", "#ffaaaa", "#ffaaaa"];
  var errorColors = ["#ff99cc", "#8fb8d8", "#ff0000", "#ff0000", "#ff0000"];
      ...
      options: {
        ...
        onResize: function(chart, size) {
          if (size.width < 800) {
            ...
            // chart.options.scales.yAxes[0].ticks.fontColor = '#ff0000';
          } else {
            // chart.options.scales.yAxes[0].ticks.fontColor = '#666666';
  ...
  (function() {
    var reportData = reportDataParam
      .map(function(report) {
